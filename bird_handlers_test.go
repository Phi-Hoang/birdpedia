...
func TestGetBirdsHandler(t *testing.T) {
	...
	/*
		Define the data that we want to return when the mocks `GetBirds` method is called
...
func TestCreateBirdsHandler(t *testing.T) {
	...
	/*
	 ...
	 We expect the first argument to the method to be the bird struct defined below, and tell the mock to return a `nil` error
	*/
